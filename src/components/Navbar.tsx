...
export function Navbar() {
  ...
  return <nav className="w-full py-4 px-4 md:px-8 bg-white/90 backdrop-blur-sm fixed top-0 z-50 shadow-sm">
      ...
      {/* Mobile menu */}
      {isMenuOpen && <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-md py-4 px-6 animate-fade-in">
          <div className="flex flex-col space-y-4">
            <a href="#features" className="text-gray-600 hover:text-easy-green py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              Features
            </a>
            <a href="#for-teens" className="text-gray-600 hover:text-easy-blue py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              For Teens
            </a>
            <a href="#for-parents" className="text-gray-600 hover:text-easy-purple py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              For Parents
            </a>
            <a href="#investments" className="text-gray-600 hover:text-easy-red py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              Investments
            </a>
            <a href="/financial-literacy" className="text-gray-600 hover:text-easy-blue py-2 transition-colors" onClick={() => setIsMenuOpen(false)}>
              Financial Literacy
            </a>
