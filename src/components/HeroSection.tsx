...
export function HeroSection() {
  ...
  return <section className="pt-20 md:pt-32 pb-16 px-4 bg-gradient-to-br from-gray-50 via-white to-gray-50">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="relative animate-fade-in-slow mt-8 lg:mt-0">
            <div className="absolute -top-4 -left-4 w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-easy-green/10 to-easy-blue/10 rounded-full blur-3xl"></div>
              ...
              <div className="p-4 md:p-6">
                <div className="flex justify-between items-center mb-4 md:mb-6">
                  <div>
                    ...
                    <p className="text-xl md:text-2xl font-bold">₹1,275.84</p>
                  </div>
                  <div className="bg-green-50 text-green-600 px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium">
                    +12.4%
                  </div>
                </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 md:ml-3">
                          <p className="text-xs md:text-sm font-medium text-left">Savings</p>
                  ...
                  <div className="p-3 md:p-4 bg-gray-50 rounded-xl">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <div className="ml-2 md:ml-3">
                          <p className="text-xs md:text-sm font-medium">Investments</p>
                          <p className="text-xs text-gray-500">Mutual Funds</p>
                        </div>
                      </div>
                      <p className="text-sm md:font-semibold">₹587.63</p>
                    </div>
                  </div>
                </div>
