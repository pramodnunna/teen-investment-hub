...
export function FeaturesSection() {
  ...
  return <section id="features" className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Everything You Need to Start Banking & Investing</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">EASY combines teen-friendly banking with guided investment opportunities, all under parental supervision.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <div key={index} className="p-6 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group">
