...
export function CTASection() {
  return (
    <section className="py-20 px-4 bg-gradient-to-r from-easy-green/10 via-easy-blue/10 to-easy-red/10">
      <div className="container mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Join thousands of families already using PayWithEasy to teach their teens about money management, 
            saving, and investing — all in one secure platform.
          </p>
